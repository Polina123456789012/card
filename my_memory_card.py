...
question_list = []
question_list.append(Question('сколько всего основных сторон света?','4','5','6','8'))
question_list.append(Question('Государственный язык Бразилии', 'Португальский', 'Бразильский', 'Испанский', 'Итальянский'))
question_list.append(Question('где восходит солнце?','на востоке','на западе','на юге','на севере'))
question_list.append(Question('Как называется еврейский Новый год?','Рош ха-Шана','Йом Кипур','Кванза','Ханука'))
...
def exit():
    ...
    AnsGroupBox.hide()
    lb_Question.setText('Правильно ' + str(window.score)+ ' из ' + str(len(question_list)))
